 ...
 */
public class PolygonParametrical implements PolygonDisplayNode {

  private String id = "param";

  public double start = 0;
  public double end = 1;
  public int nPoints = 11;
  public String formula = "x = cos(2*pi*t); y = sin(2*pi*t);";
...
//  private Dlg_PolygonParametrical editor = null;
  ...
  public pvs.Expression.Parser m_parser = new pvs.Expression.Parser();  
