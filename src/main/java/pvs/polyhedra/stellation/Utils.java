...
public class Utils {
    ...
    */
     ...
     *
     */
    public static Vector3D[] getCanonicalVectors(Vector3D planes[], String polySymmetry){
    ...
    public static Vector3D[] planesToVectors(Plane planes[]){
    ...
    public static Plane[] vectorsToPlanes(Vector3D vectors[]){
