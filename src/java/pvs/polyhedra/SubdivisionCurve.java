 ...
 *
 */
class SubdivisionCurve implements PolygonDisplayNode, PVSObserver {

  private String id = "curve";

  private Dlg_SubdivisionCurve editor = null;
  ...
  */
  ...
  public PolygonEditor getEditor(){
    ...
    if(editor == null)
      editor = new Dlg_SubdivisionCurve(this);    
    return editor;
  }
