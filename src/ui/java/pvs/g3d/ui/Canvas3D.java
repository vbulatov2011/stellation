...
import pvs.utils.ui.DestroyableFrame;
import pvs.utils.ui.GraphicsPS;
...
public class Canvas3D extends Panel implements Runnable{
    ...
    int displayType = Model3D.NORMAL;
    ...
    */  
    public void paintCanvas(Graphics g) {
        ...
        case Model3D.NORMAL: 
            drawNormalImage(g);
            break;
        case Model3D.ANAGLYPH_CR:
            drawAnaglyph(g,anaglyphAngleGrad);
            break;
        case Model3D.ANAGLYPH_RC:
            drawAnaglyph(g,-anaglyphAngleGrad);
            break;
        case Model3D.STEREO_PARALLEL:
            drawStereo(g,anaglyphAngleGrad);
            break;
        case Model3D.STEREO_CROSSED:
            drawStereo(g,-anaglyphAngleGrad);
            break;
        }
