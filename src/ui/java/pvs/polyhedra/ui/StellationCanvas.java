...
public class StellationCanvas extends Panel implements Runnable{
  ...
  pvs.utils.ui.Graphics2D g2d = new pvs.utils.ui.Graphics2D();
  double Width = 0;
  ...
  */
  ...
  public void run(){
	...
	System.out.println("printing diagram to file " + fileName);
      } catch(Exception e){
	f = System.out;
	System.out.println("---------start of PS");
	System.out.println("printing diagram to java console" );
      }
